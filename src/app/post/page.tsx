    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <button onClick={() => router.back()} className="mt-4 text-pink-500 hover:underline">
            Volver
          </button>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white border-b sticky top-0 z-10">
          <div className="flex items-center px-4 py-3">
            ...
            <h1 className="text-xl font-semibold ml-2">Publicación</h1>
          </div>
        </div>
            ...
            <div className="p-4">
              ...
              <div className="flex space-x-2">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-xl disabled:opacity-50"
                >
